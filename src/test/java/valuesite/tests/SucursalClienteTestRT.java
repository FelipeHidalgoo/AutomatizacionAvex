...
import valuesite.pageobjects.SucursalClienteRT;
import valuesite.testcomponents.BaseTest;


public class SucursalClienteTestRT extends BaseTest{
	
	SucursalClienteRT suc;
	ComponentesReusables cp;
	
	@BeforeTest
	public void setUp() {
		suc = new SucursalClienteRT(getDriver());
